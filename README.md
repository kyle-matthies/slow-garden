...
Slow Garden is a private, contemplative thinking environment built around temporal co-thinking: the person captures and arranges ideas without interruption, then an asynchronous AI process returns later with a small number of source-linked connections, tensions, and questions.
...
- Kyle-first, private, single-user learning lab.
...
- Native iOS is the primary product; the web companion reuses backend contracts and semantics without forcing shared UI code.
